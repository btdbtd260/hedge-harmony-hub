...
import type { EmailPayload } from './send-email.ts'
...
// Uses EmailRateLimitedError.status when available (status === 429),
// falls back to parsing the error message as a safety net.
...
// Extract Retry-After seconds from EmailRateLimitedError.retryAfterSeconds, or default to 60s.
